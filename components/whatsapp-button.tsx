...
export function WhatsAppButton() {
  const phoneNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '18099998469';
  const message = encodeURIComponent('Hola, me interesa conocer más sobre Alternative 3D Studio');
